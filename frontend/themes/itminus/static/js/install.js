...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _install = __webpack_require__(876);
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/', component: _install2.default.Main },
	        _react2.default.createElement(_reactRouter.IndexRoute, { component: _install2.default.Home })
	    )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = { Main: Main, Home: _home2.default };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _steps = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"antd/lib/steps\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"antd/lib/steps/style/css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var _install = __webpack_require__(885);
	...
	var Home = exports.Home = function (_React$Component) {
	    ...
	    function Home(props) {
	        ...
	        _this.promiseSetState = _this.promiseSetState.bind(_this);
	    ...
	    _createClass(Home, [{
	        ...
	        value: function promiseSetState(state) {
	            ...
	            this.setState(state, function () {
	                console.log('\u5DF2\u7ECF\u8FDB\u884C\u5230step: ' + _this2.state.current + ' ');
	                return Promise.resolve(_this2.state);
	            });
	        }
	    }, {
	        key: 'install',
	        value: function install() {
	            ...
	            // 依次安装 ，设置状态
	            this.setState({ status: 'process' }, function () {
	                var current = 0;
	                // 创建数据库
	                _install2.default.createDb().then(function () {
	                    //完成后，进入下一步骤
	                    return _this3.promiseSetState({ current: ++current });
	                })
	                // 填充核心信息
	                .then(function () {
	                    var rootUser = _this3.state.rootUser;
	                    return _install2.default.initializeCore();
	                }).then(function () {
	                    return _this3.promiseSetState({ current: ++current });
	                })
	                ...
	                .then(function () {
	                    var rootUser = _this3.state.rootUser;
	                    return _install2.default.createRootUser(rootUser.username, rootUser.password, rootUser.email);
	                }).then(function () {
	                    return _this3.promiseSetState({ current: ++current });
	                }).then(function () {
	                    return _install2.default.initializeTable();
	                }).then(function () {
	                    return _this3.promiseSetState({ current: ++current });
	                }).catch(function (e) {
	                    console.log(_this3.state);
	                    return _this3.setState({ status: 'error', current: current, msg: e.msg });
	                });
	            });
	        }
	    }, {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _form2.default.Item,
	                                _extends({ label: '\u5E10\u6237\u540D' }, formItemLayout),
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            _button2.default,
	                            { type: 'primary', onClick: this.install },
	                            ' \u5F00\u59CB '
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _col2.default,
	                        { md: 18 },
	                        _react2.default.createElement(_alert2.default, { message: this.state.msg, type: this.state.status == 'error' ? 'error' : 'info' }),
	                        _react2.default.createElement(
	                            _card2.default,
	                            { title: '\u5B89\u88C5\u8FDB\u5EA6' },
	                            _react2.default.createElement(
	                                _steps2.default,
	                                { direction: 'vertical', current: this.state.current, status: this.state.status },
	                                _react2.default.createElement(_steps2.default.Step, { title: '\u5B89\u88C5\u6570\u636E\u5E93', description: '\u6570\u636E\u5E93\u5B89\u88C5' }),
	                                _react2.default.createElement(_steps2.default.Step, { title: '\u521D\u59CB\u5316\u6838\u5FC3\u6570\u636E', description: '\u586B\u5145\u89D2\u8272\u8868\u7B49' }),
	                                _react2.default.createElement(_steps2.default.Step, { title: '\u521B\u5EFA\u8D85\u7EA7\u7BA1\u7406\u5458', description: '\u5B89\u88C5\u8D85\u7EA7\u7BA1\u7406\u5458' }),
	                                _react2.default.createElement(_steps2.default.Step, { title: '\u586B\u5145\u57FA\u672C\u7684\u6570\u636E', description: '\u586B\u5145\u8BED\u8A00\u8868\u3001\u56FD\u5BB6\u8868\u7B49' }),
	                                _react2.default.createElement(_steps2.default.Step, { title: '\u5B8C\u6210', description: '' })
	                            )
	                        )
	                    )
	                )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.initializeTable = exports.createRootUser = exports.initializeCore = exports.createDb = undefined;
	...
	var createDb = exports.createDb = function createDb() {
	    return client.get('/install/create-db').then(function (resp) {
	        return resp.data;
	    }, function (e) {
	        throw e;
	    }).then(function (info) {
	...
	var initializeCore = exports.initializeCore = function initializeCore() {
	    return client.post('/install/init-core').then(function (resp) {
	        return resp.data;
	    }, function (e) {
	        throw e;
	    }).then(function (info) {
	...
	var createRootUser = exports.createRootUser = function createRootUser(username, password, email) {
	    return client.post('/install/create-root-user', JSON.stringify({ username: username, password: password, email: email }), {
	        headers: {
	...
	var initializeTable = exports.initializeTable = function initializeTable() {
	    return client.post('/install/init-db').then(function (resp) {
	        return resp.data;
	    }, function (e) {
	        throw e;
	    }).then(function (info) {
